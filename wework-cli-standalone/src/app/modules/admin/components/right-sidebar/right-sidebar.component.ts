...
export class RightSidebarComponent extends UnsubscribeOnDestroyAdapter implements OnInit, AfterViewInit {
    public selectedBgColor = 'white';
    public maxHeight: string | undefined;
    public maxWidth: string | undefined;
    public showpanel = false;
    public isOpenSidebar: boolean | undefined;
    public isDarkSidebar = false;
    public isDarTheme = false;
    public isRtl = false;
    public config: any = {};
    ...
    ngAfterViewInit() {
        console.log('Aqui el tema de la APP en Rigth SideBar', localStorage.getItem('theme'));
        console.log(
            'Aqui el choose_skin de la APP en Rigth SideBar',
            localStorage.getItem('choose_skin'),
        );
        console.log(
            'Aqui el menuOption de la APP en Rigth SideBar',
            localStorage.getItem('menuOption'),
        );
        console.log('Aqui el isRtl de la APP en Rigth SideBar', localStorage.getItem('isRtl'));
